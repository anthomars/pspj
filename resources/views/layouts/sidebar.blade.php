<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
      ...
      <h1 class="navbar-brand">
        <a href="/">
          <img src="{{ asset('storage/' . appSetting()->logo_apps) }}" width="110" height="24" alt="{{ appSetting()->nama_apps }} Logo" class="navbar-brand-image p-1"><b style="font-size:14px;">{{ appSetting()->nama_apps }}</b>
        </a>
      </h1>
        ...
        <div class="nav-item dropdown">
          <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
            ...
            <div class="d-none d-xl-block ps-2">
              ...
              <div class="mt-1 small text-muted">{{  Auth::user()->nama_lengkap }}</div>
            </div>
          </a>
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="{{ url('user/profile') }}" class="dropdown-item">Settings</a>
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ Request::is('user-account') ? 'changed' : '' }} {{ Request::is('master-data*') ? 'changed' : '' }}" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ Request::is('iuran*') ? 'changed' : '' }}" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ Request::is('laporan*') ? 'changed' : '' }}" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
                <span class="nav-link-icon d-md-none d-lg-inline-block ms-1"><!-- Download SVG icon from http://tabler-icons.io/i/lifebuoy -->
            ...
            <div class="dropdown-menu {{ Request::is('laporan*') ? 'show' : '' }}">
                <a class="dropdown-item {{ Request::is('laporan/iuran-bulanan') ? 'active' : '' }}" href="{{ url('/laporan/iuran-bulanan') }}" rel="noopener">
                    Iuran Bulanan
                </a>
                <a class="dropdown-item {{ Request::is('laporan/biaya-pemakaman') ? 'active' : '' }}" href="{{ url('/laporan/biaya-pemakaman') }}" rel="noopener">
                    Biaya Pemakaman
                </a>
            </div>
          </li>
