                    ...
                    <form id="makamUpdateForm" >
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control number change_number_format" name="nominal_biaya" id="nominal_biaya"  placeholder="Masukan Nominal Biaya" value="{{ number_format($makam->nominal_biaya) }}">
