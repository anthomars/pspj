    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Biaya Pemakaman</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="container-xl mt-3">
    <div class="card">
        <div class="card-body">
            <form id="filterForm" action="{{ route('laporan.biaya_pemakaman') }}" method="GET">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="filter_year" name="year">
                            <option value="">All</option>
                            @foreach ($data['pemakaman']->unique('date_created') as $iuran)
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="invoice p-3 mb-3">
                            ...
                            @foreach ($data['pemakamanPerRw'] as $rw => $tahunData)
                                                ...
                                                <tbody>
                                                    @php
                                                        ...
                                                        foreach ($laporan as $item) {
                                                            ...
                                                            $rt_monthly_totals[$rt][$year][$month] += $item->nominal_biaya;
                                                        }
                                                    @endphp
