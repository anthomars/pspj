    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Add Jenazah</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="page-body">
    <div class="container-xl">
        <div class="card">
            <form action="{{ url('jenazah') }}" method="POST" onsubmit="splashLoading()" enctype= "multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="nama_jenazah" name="nama_jenazah" class="form-control @error('nama_jenazah') is-invalid @enderror" placeholder="Title" value="{{ old('nama_jenazah') }}"/>
                                @error('nama_jenazah')
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="input-icon mb-2">
                                    <input class="form-control" placeholder="Select a date" id="tgl_lahir" name="tgl_lahir" {{-- value="{{ $jenazah ? date('Y-m-d',strtotime($jenazah->tgl_lahir)) : date('Y-m-d') }}" --}}>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="input-icon mb-2">
                                    <input class="form-control" placeholder="Select a date" id="tgl_wafat" name="tgl_wafat" {{-- value="{{ $jenazah ? date('Y-m-d',strtotime($jenazah->tgl_wafat)) : date('Y-m-d') }}"  --}}>
                                    <span class="input-icon-addon"><!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z"></path><path d="M16 3v4"></path><path d="M8 3v4"></path><path d="M4 11h16"></path><path d="M11 15h1"></path><path d="M12 15v3"></path></svg>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" placeholder="Title" value="{{ old('tempat_lahir') }}"/>
                                @error('tempat_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="tempat_wafat" name="tempat_wafat" class="form-control @error('tempat_wafat') is-invalid @enderror" placeholder="Title" value="{{ old('tempat_wafat') }}"/>
                                @error('tempat_wafat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="nik" name="nik" class="form-control @error('nik') is-invalid @enderror" placeholder="Title" value="{{ old('nik') }}"/>
                                @error('nik')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea id="alamat" name="alamat" data-bs-toggle="autosize" class="form-control @error('alamat') is-invalid @enderror" placeholder="Address"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
